...
1. **Pricing power**: You can charge $20/month for a product people love. You can't charge extra for "Gmail, but with AI" when people expect Gmail to be free
2. **Switching costs**: If users don't know they're using Gemini, they don't care if it's replaced by something else
3. **Quality perception**: When Gemini hallucinates inside Gmail, users blame Gmail, not Gemini. The brand damage is diffuse but real
