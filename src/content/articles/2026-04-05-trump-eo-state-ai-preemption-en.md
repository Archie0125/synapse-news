...
1. **Extraterritorial reach**: Laws that attempt to regulate AI systems or developers located outside the state's borders.
2. **Conflict with federal AI standards**: Laws that impose requirements that directly contradict emerging federal guidelines for AI in healthcare, financial services, or national security contexts.
3. **Barriers to federal AI procurement**: Laws that would prevent state government agencies from using AI tools acquired under federal contracts.
